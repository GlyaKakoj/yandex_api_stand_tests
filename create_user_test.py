...
# Тест 5. Позитивная проверка.
# Параметр fisrtName состоит из английских букв
def test_create_user_english_letters_in_first_name_positive_response():
    positive_assert("QWErty")


# Тест 6. Позитивная проверка.
# Параметр fisrtName состоит из русских букв
def test_create_user_russian_letters_in_first_name_positive_response():
    positive_assert("Мария")


# Тест 7. Негативная проверка.
# В параметре fisrtName запрещены пробелы
def test_create_user_has_space_in_first_name_get_error_response():
    negative_assert_symbol("Человек и Ко")


# Тест 8. Негативная проверка.
# В параметре fisrtName запрещены спецсимволы
def test_create_user_has_special_symbol_in_first_name_get_error_response():
    negative_assert_symbol("#%@")


# Тест 9. Негативная проверка.
# В параметре fisrtName запрещены цифры
...
def negative_no_first_name(user_body):
    # В переменную user_response сохраняется результат запроса на создание пользователя
    user_response = sender_stand_request.post_new_user(user_body)
...
def test_create_user_no_first_name_get_error_response():
    ...
    negative_no_first_name(user_body)
